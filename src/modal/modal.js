        ...
        return (
            <div id='modal'>
                <h2 id='editTitle'>&#9998; Edit Task</h2>
                    <input type="text" className='editInp' value={this.state.editedTask} onChange={this.writeEditedTaskHandler}/>
                    <button className='cancelBtn' onClick ={this.props.closeModal}>Cancel</button>

                    <button className='editBtn' onClick={() => this.editTaskHandler(this.props.closeModal)}>Edit</button>
            </div>
        )
    }
}
